...
class ResultSetImpl extends BaseImpl {
  ...
  //
  // Fetches all the rows from the database to use internally. getRows()
  // already materializes and consumes each batch, so this method only
  // accumulates the returned rows.
  //---------------------------------------------------------------------------
  async _getAllRows() {
